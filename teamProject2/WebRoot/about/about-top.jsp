  		...
  		<tr>
  			...
  			<td width="80%" height="600px" style="text-align:left;">
	  			<div style="width:100%; height:100%; background:#DDD;">
		  			...
		  			<blockquote style="color:#444; font-size:16px;">&nbsp;&nbsp;<a name="introdece" id="introduce">目前，</a>包括校本部和新校区两个分馆，新图书馆面积34500平方米，是湖南省高校中最大的图书馆之一，于2013年9月新学期正式启用。藏书300多万册，其中纸本藏书200多万册，电子图书43.68万册。
		  			...
		  			<blockquote style="color:#444; font-size:16px;">&nbsp;&nbsp;<a name="time" id="time">周一——周四：8:00-22:00</a>
		  			<br>&nbsp;&nbsp;周&nbsp;&nbsp;&nbsp;&nbsp;五：闭馆。
